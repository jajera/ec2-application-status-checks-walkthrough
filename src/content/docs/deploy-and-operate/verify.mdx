...
<DocsImage
  src="images/console-application-status-details-excluded-passed.png"
  alt="Application status details: check asc-4b895121 passed with ResponseCodeMatched, aggregation Excluded"
/>
...
<DocsImage
  src="images/console-status-and-alarms-included-passed.png"
  alt="EC2 Status checks: system, instance, EBS, and Application status all Check passed after the check is included"
/>

Details show the same check as **Included** and **passed**.

<DocsImage
  src="images/console-application-status-details-included-passed.png"
  alt="Application status details: check asc-4b895121 passed with ResponseCodeMatched, aggregation Included"
/>
...
<DocsImage
  src="images/console-application-status-details-recovered-passed.png"
  alt="Application status details after restarting health.py: passed, ResponseCodeMatched, aggregation Included"
/>
